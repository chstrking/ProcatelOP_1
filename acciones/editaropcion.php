...
<div class="area_editar">
	<div class="cabecera_editar" align="left"><i class="fa fa-tags"></i><?php echo $Titulo ?> Opci&oacute;n</div>
		<table class="table">	
			...
			<table class="col-sm-4">
				...
				<tr>
					...
					<td>
						...
						<div class="form-group">
							<label class="control-label">Opci&oacute;n</label>
							<div class="controls">
				...
				<tr>
					...
					<td>
						<div class="form-group">
							...
							<div class="controls">
								<div class="input-group">
									<input id="ModuloNombre" readonly="readonly" class="form-control" type="text" size="16" placeholder="Módulos" value="<?php echo $NombreMod ?>">
									<input id="ModuloID" type="hidden" value="<?php echo $idMod ?>">
									<span class="input-group-btn">
										<button onclick="Buscar('14')" id="bt_vendedor" class="btn" type="button"><i class="fa fa-search"></i></button>
									</span>
								</div>
							</div>
						</div>
				...
				<tr>
					...
					<td>
						...
						<div class="form-group">
							...
							<div class="controls">
								<div class="input-group">
									<input id="NombrePantalla" class="form-control" type="text" maxlength="50" size="50" placeholder="Nombre Opción" width="400px" value="<?php echo $NombrePant?>">
								</div>
							</div>
						</div>
				...
				<tr height="50px">
					<td><div class="boton_save" onclick="GuardarOpcion()" height="40px">Guardar</div></td>
					<td></td>
				</tr>
