...
$content = ObtenerFacturaHTML($sucursalId);
...
function ObtenerFacturaHTML($codigo)
{
	$conexion=crear_conexion();
	//$dato = ultima_factura($conexion,$codigo);
	//$datos=Print_Factura($conexion,$codigo,$_SESSION['usuario']);
	//var_dump($_SESSION['usuario']);
	$datos1 = ultima_factura($conexion,$_SESSION['usuario']);
	$datos=RPrint_Factura($conexion,$datos1[0]["VFact_Codigo"]);
	//var_dump($datos);
	ActualizaEstadoPagado($conexion,$datos[0]["codigo"]);
