...
<div class="row">
	<div class="col-sm-12">
		<div class="panel">
			<div class="panel-heading">Reversar Factura</div>
			<table class="table">
			  <tr>
				<td>
			  ...
			  <tr>
				<td>
					<div class="form-group">
						...
						<div class="controls">
							<select id="mytextarea" class="form-control">
			...
			<table align="right" width="20%" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td colspan="2" align="center">
						<button onclick="Guardar_Facturacion()" type="button" class="boton_save"><i class="fa fa-save"></i> Imprimir</button> 
					</td>
				</tr>
			</table>
			</div>
