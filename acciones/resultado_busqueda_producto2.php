...
<?php if(count($respuestas)!=0){?>
	...
	<?php foreach($respuestas as $respuesta){?>
			...
			<td><button id="detalle_facturacion" class="boton_save boton_icon" type="button" onclick="IngresarDetalleFacturacion2('<?php echo $respuesta['DProd_Codigo'];?>')" title="Seleccionar"><i class="fa fa-check-square-o"></i></button></td>
			</tr>
			<?php $i++;?>
	<?php }?>
<?php }else{?>
