...
?>
	...
	<?php 
		$detalle_facturacion=array('cantidad'=>$cantidad,'descuento'=>$descuento,'numeroserie'=>$numeroserie,'numerolinea'=>$numerolinea,'id_html'=>$detalleid,'costo'=>$respuesta['Pro_Costo']);
	...
	<td class="padding_tabla_accion">
		<a class="btn btn-xs btn-warning" href="javascript:;" onclick="EditarDetalle('<?php echo $respuesta['DProd_Codigo'];?>','<?php echo $codigo_categoria?>')" title="Editar">
		<i class="fa fa-edit"></i>
		</a>
		<a class="btn btn-xs btn-danger" href="javascript:;"  onclick="EliminarDetalle('<?php echo $respuesta['DProd_Codigo'];?>','<?php echo $detalleid?>','<?php echo $codigo_categoria?>','<?php echo $respuesta['Pro_Codigo'];?>')"  title="Eliminar">
