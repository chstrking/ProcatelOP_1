			...
			<table class="table">
				...
				<td width="33%">
					<div class="form-group">
						...
						<div class="input-group col-xs-8 col-sm-8">
							<input id="FechaCad" class="form-control date-picker" type="text" data-date-format="dd-mm-yyyy" readonly="readonly" value="<?php echo $desde ?>">
			  ...
			  <tr>
					...
					<div class="form-group">
						<div class="controls">
							...
							<div class="input-group">
								<input id="BodegaNombre" class="form-control" type="text" size="16" placeholder="Cliente" readonly="readonly">
								<input type="hidden" id="BodegaID" value="">
								<span class="input-group-btn">
									<button onclick="Buscar('4')" id="bt_cliente" class="btn" type="button"><i class="fa fa-search"></i></button>
								</span> 
							</div>
						</div>
					</div>
				...
				<td>
					<div class="form-group">
						...
						<div class="controls">
							<div class="input-group">
								<input id="ProveedorNombre" class="form-control" type="text" size="16" placeholder="Proveedor" readonly="readonly">
								<input id="ProveedorID" type="hidden" value="">
								<span class="input-group-btn">
									<button onclick="Buscar('29')" id="bt_vendedor" class="btn" type="button"><i class="fa fa-search"></i></button>
								</span>
							</div>
						</div>
					</div>
			  ...
			  <tr>
				<td>
					<div class="form-group">
						...
						<div class="controls">
							<input id="NoFact" class="form-control" type="text" size="16" placeholder="No. Factura">
						</div>
					</div>
				</td>
				<td width="33%"> 
			  ...
			  <tr>
				<!--<td>
					<div class="form-group">
						<!--<label class="control-label" for="date01">Fecha Caducidad</label>
						<div class="controls">
							<input id="FechaCaducidad" class="form-control" type="hidden" size="16" placeholder="Fecha de Caducidad" disabled=">
						</div>
					</div>
				</td>-->
				<!--<td>
			  ...
			  <tr>
				<td width="33%">
					...
					<div class="controls">
						<select id="TipoFacturacion" style="visibility:hidden" class="form-control">
									...
									<tbody>
										<tr>
											...
											<td class="padding_td_tablas" align="left" valign="middle" style="width:12%">
												<button id="detalle_facturacion" class="boton_save" type="button"  onclick="BuscarProductoI()"><i class="fa fa-plus-square"></i> Nuevo</button>
											</td>
										</tr>
									</tbody>
			</table>
			...
			<table align="right" width="20%" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td colspan="2" align="center">
						<button onclick="Guardar_FacturacionC()" type="button" class="boton_save"><i class="fa fa-save"></i> Guardar</button> 
					</td>
				</tr>
			</table>
			</div>
