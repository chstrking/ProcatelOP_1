...
if(isset($_SESSION['usuario'])) 
{
	...
	else
	{
		...
		try{
			...
			$where = "where CodigoDescuento = '$id'";
			...
			foreach($mbd->query('select DISTINCT `CodigoDescuento`, `NombreDescuento`, `PorcentajeDescuento`, `Estado` from descuento '.$where) as $fila) {
				$nombre=$fila['NombreDescuento'];
			...
			<table class="col-sm-4">
						...
						<div class="form-group">
							...
							<div class="controls">
								<div class="input-group">
									<input id="NombreDescuento" class="form-control" type="text" maxlength="50" size="50" placeholder="Descuento" width="400px" value="<?php echo $nombre?>">
				...
				<tr>
					...
					<td>
						...
						<div class="form-group">
							<div class="controls">
								<input id="ValorDescuento" class="form-control" type="text" maxlength="50" size="50" placeholder="valor del descuento" width="400px" value="<?php echo $nombre?>">
							</div>
						</div>
