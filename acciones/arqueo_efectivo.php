...
<div class="action-nav-normal action-nav-line">
	<div class="row">
		<div class="col-sm-2 action-nav-button">
			<a title="Nuevo Usuario" href="#" onclick="ImprimirArqueoefectivo()">
...
<div class="row">
	<div class="col-sm-12">
		<div class="panel">
			<div class="panel-heading">Arqueo de Efectivo</div>
			<table class="table">
			  <tr>
			  <td width="33%">
				...
				<td width="33%">
					<div class="form-group">
						...
						<div class="input-group col-xs-8 col-sm-8">
							<input id="fechaId" class="form-control date-picker" type="text" readonly="readonly" data-date-format="dd-mm-yyyy">
