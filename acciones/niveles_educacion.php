...
<div class="area_editar">
	<div class="cabecera_editar" align="left"><i class="fa fa-tags"></i><?php echo $Titulo ?> Niveles de educaci&oacute;n</div>
						...
						<div class="form-group">
							...
							<div class="controls">
								<div class="input-group">
									<input id="NombreNivel" class="form-control" type="text" size="50" maxlength="50" placeholder="Nombre del nivel de educaciòn" width="400px" value="<?php echo $Nombre?>">
